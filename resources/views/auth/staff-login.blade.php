...
@section('title', 'Staff Login - ' . setting('site_name', 'Smart Complaint System'))
...
<div class="auth-split-container fade-in">
    <div class="auth-split-card slide-up">
        ...
        <div class="auth-split-form" style="position: relative;">
            ...
            <h2 class="auth-title">Staff Console</h2>
            <p class="auth-subtitle">
                Please log in to manage your assigned complaints.
            </p>
            ...
            <form action="{{ route('login') }}" onsubmit="submitLogin(event)" autocomplete="off">
                @csrf
                <div class="form-group">
                    <label for="login-email">Staff Email Address</label>
                    <input type="email" id="login-email" name="email" class="form-control" placeholder="plumber@complaint.system" required autofocus readonly onfocus="this.removeAttribute('readonly');">
                </div>
            ...
            <div class="text-left mt-4" style="font-size: 0.9rem;">
                <span class="text-muted">Don't have a staff account?</span>
                <a href="{{ route('staff.register') }}" class="font-weight-bold" style="color: #705ecf; text-decoration: none;">Register Now</a>
            </div>
        </div>
    </div>
</div>
