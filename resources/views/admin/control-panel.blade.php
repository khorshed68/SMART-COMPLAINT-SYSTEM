...
<div class="fade-in-up">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="card border-0 shadow-sm rounded-4 text-center mb-4" style="border-top: 4px solid var(--primary) !important;">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('admin.complaints') }}" class="btn btn-outline-primary w-100 py-2 font-weight-bold" style="border-radius: 12px;">Open Manager</a>
                </div>
            </div>
        </div>
        ...
        <!-- Users Management -->
        <div class="col-md-4 col-sm-6">
            <div class="card border-0 shadow-sm rounded-4 text-center mb-4" style="border-top: 4px solid var(--dark) !important;">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('admin.users') }}" class="btn btn-outline-primary w-100 py-2 font-weight-bold" style="border-radius: 12px;">Open Manager</a>
                </div>
            </div>
        </div>
        ...
        <!-- Categories Settings -->
        <div class="col-md-4 col-sm-6">
            <div class="card border-0 shadow-sm rounded-4 text-center mb-4" style="border-top: 4px solid var(--secondary) !important;">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('admin.categories') }}" class="btn btn-outline-primary w-100 py-2 font-weight-bold" style="border-radius: 12px;">Open Config</a>
                </div>
            </div>
        </div>
        ...
        <!-- Analytics charts -->
        <div class="col-md-4 col-sm-6">
            <div class="card border-0 shadow-sm rounded-4 text-center mb-4" style="border-top: 4px solid var(--info) !important;">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('admin.analytics') }}" class="btn btn-outline-primary w-100 py-2 font-weight-bold" style="border-radius: 12px;">Open Analytics</a>
                </div>
            </div>
        </div>
        ...
        <!-- System settings -->
        <div class="col-md-4 col-sm-6">
            <div class="card border-0 shadow-sm rounded-4 text-center mb-4" style="border-top: 4px solid var(--warning) !important;">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('admin.settings') }}" class="btn btn-outline-primary w-100 py-2 font-weight-bold" style="border-radius: 12px;">Configure Settings</a>
                </div>
            </div>
        </div>
        ...
        <!-- System Diagnostics -->
        <div class="col-md-4 col-sm-6">
            <div class="card border-0 shadow-sm rounded-4 text-center mb-4" style="border-top: 4px solid var(--danger) !important;">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('admin.system-health') }}" class="btn btn-outline-primary w-100 py-2 font-weight-bold" style="border-radius: 12px;">Check Health</a>
                </div>
            </div>
        </div>
    </div>
