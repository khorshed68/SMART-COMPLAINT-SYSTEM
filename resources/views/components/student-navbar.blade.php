    ...
    <div class="d-flex align-items-center" style="gap: 15px;">
        ...
        <div class="breadcrumbs" style="font-size: 0.85rem; color: var(--dark); font-weight: 500;">
            ...
            <span class="font-weight-bold" style="color: var(--primary);">
                ...
                @elseif(Request::routeIs('complaints.create')) Submit Complaint
                @elseif(Request::routeIs('complaints.index')) My History
                @elseif(Request::routeIs('complaints.show')) Complaint Details
                @elseif(Request::is('announcements*')) Announcements
